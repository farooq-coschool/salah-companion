        ...
        {surahArabic.ayahs.map((ayah, index) => {
          ...
          return (
            <motion.div 
              ...
              key={ayah.number} 
              className={`bg-white/85 backdrop-blur-sm p-8 rounded-[2.5rem] shadow-sm border transition-all duration-300 ${playingAyah === ayah.number ? 'border-gold-400/60 shadow-gold-500/10 shadow-lg scale-[1.01]' : 'border-stone-200/60 hover:shadow-md hover:border-gold-300/40'}`}
            >
