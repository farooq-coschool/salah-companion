...
import { Search, Heart, Shield, Sun, Moon, Coffee, Play, Square, BookOpen, LifeBuoy, Plane, Users, Sparkles } from 'lucide-react';
                ...
                <div key={dua.id} className="surface surface-interactive p-6 rounded-3xl">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button className="p-2 text-stone-400 hover:text-rose-500 hover:bg-stone-50 rounded-full transition-colors">
