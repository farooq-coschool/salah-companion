...
import { Home, BookOpen, Music, Settings, Heart, Star, Calendar as CalendarIcon, Compass, CircleDot, ListChecks, MapPinned } from 'lucide-react';
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { path: '/tasbih', label: 'Tasbih', icon: CircleDot },
    { path: '/prayer-tracker', label: 'Tracker', icon: ListChecks },
    { path: '/mosque-finder', label: 'Mosques', icon: MapPinned },
