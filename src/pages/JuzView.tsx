...
export default function JuzView() {
  ...
  const { translation, setTranslation, reciter, arabicFontSize } = useSettingsStore();
  ...
  const toggleAyahAudio = (ayahNumber: number) => {
    if (playingAyah === ayahNumber) {
      ...
      audioRef.current = new Audio(`https://cdn.islamic.network/quran/audio/128/${reciter}/${ayahNumber}.mp3`);
